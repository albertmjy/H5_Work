		...
		$.getJSON("/news/" + id, function(data){
			$.each(data, function(i, v){
				switch (id){
					...
					default:
						console.warn("No matching news: " + id )
				}
			})
		})
	}
...
function EventListener(){
	...
	this._recommandTabClick = function(){
		...
		this.recommandTab.click(function(){
			...
			newsHandler.loadNews("recommand")
			count++
		})
	}
	...
	this._entertainmentTabClick = function(){
		...
		this.entertainmentTab.click(function(){
			...
			newsHandler.loadNews("entertainment")
			count++
		})
	}
